(async function(){
  ...
  log("============================================");
  log("FORMULAR 1400 - SCAN v34 (Multi-Page)");
  log("Empfangsvollmacht immer durchlaufen");
  ...
  if(istVorblatt){
    ...
    if(!isTimedOut()){
      ...
      if(antrag2){
        ...
        await klickeUndScanne("Vorblatt_kreuz_umfangvertr_ja", "Vertr Aend Ja");
        // Registereintrag des Vertretenen
